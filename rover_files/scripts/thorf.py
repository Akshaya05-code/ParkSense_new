...
def clean_ocr_text(text):
    ocr_str = re.sub(r'[^A-Za-z0-9]', '', text).upper()
...
def detection_loop():
    ...
    try:
        ...
        inference = ModelInference(loader, conf_threshold=0.5, iou_threshold=0.45)  # Lowered conf_threshold
