...
from yaw import get_yaw, adjust_steering_for_yaw  # Import yaw correction functions
    ...
    try:
        ...
        while time.time() - start_time < DURATION:
            try:
                ...
                # Adjust steering for yaw correction and keep rover moving
